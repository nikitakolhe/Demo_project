...
class ServiceDemoImplTest {
    ...
    void setUp() {
        ...
        aemContext.load().json("/servicedemo.json","/home");
    }

    @Test
    void getUsersList()  throws RepositoryException, NoSuchFieldException {

        ServiceDemo serviceDemo = aemContext.request().adaptTo(ServiceDemo.class);
        ...
        PrivateAccessor.setField(serviceDemo, "queryBuilder", queryBuilder);
        ...
        assertEquals(" "+"\r\nugam1",serviceDemo.getUsersList());
    }
    }
