...
@Component(
        ...
        property = {
                "sling.servlet.resourceTypes=" + "/apps/ugam1/dropdowns"
        }
)
public class DynamicDataSourceServlet extends SlingSafeMethodsServlet {
    ...
    protected static final String RESOURCE_TYPE = "/apps/ugam1/dropdowns";
    ...
    protected void doGet(SlingHttpServletRequest request, SlingHttpServletResponse response) {
        ...
        try{
            ...
            Resource jsonResource = resourceResolver.getResource("/content/dam/ugam1/country.json");
