package com.ugam1.core.constants;
...
public class AppConstants {
    ...
    public static final String COUNTRY_LIST_PATH = "/content/dam/ugam1/country.json";
    public static final String COLOR_LIST = "colorList";
    public static final String COLOR_LIST_PATH = "/content/dam/ugam1/color.json";
    public static final String FONT_LIST = "fontList";
    public static final String FONT_LIST_PATH = "/content/dam/ugam1/font.json";
